...
def main():
    ...
    print("Firmware version will be automatically generated from source hash during build")
    ...
    for env in environments:
        ...
        print(f"  Version: Automatically generated from source hash")
        
        # Build firmware (version will be automatically generated by pre-script)
        try:
        ...
        # Read the generated version from the version file created by the pre-script
        firmware_version = "UNKNOWN"
        try:
            with open("firmware_version.json", 'r') as f:
